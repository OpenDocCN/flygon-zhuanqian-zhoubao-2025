...
![](img/ddde66c75dded423f552a47e7265a8b4.png)
...
![](img/381db21e728e0e6c0dd35c73c83276fe.png)
...
![](img/39ac6ba3c538219984f01ce21b04f5e0.png)
...
![](img/4ce4ec438aaae13eb0881df58b95729d.png)
...
![](img/713210e40a916f3a00438024ff199a5d.png)
...
![](img/5852f2d6981cb403cf49a842f160714e.png)
...
![](img/4344c82f7ef559d9f88584bdfa51f20e.png)
...
示例输出格式：  
类型：标题模板  
模板： "___正在毁掉年轻人？这___个真相扎心了"  
示例： "熬夜正在毁掉年轻人？这3个真相扎心了"  
适用场景：健康、职场  
情绪标签：焦虑、警示  
```
...
2.内容领域：情感  
3.情绪触发点：共鸣、意外  
4.输出要求：请从'如果是提炼，请在此处粘贴需要分析的开头内容'中提炼出1个模板，并给出优化建议。  
```
...
请根据以下要求，生成/提炼爆款素材模板：
1\. 素材类型：  
故事素材 / 数据素材 / 金句素材（请选择一种）
2.内容领域：职场 / 情感 / 健康 / 理财 / 科技 / 教育（请选择一种）
3.情绪触发点：  
好奇 / 焦虑 / 共鸣 / 警示 / 启发 / 行动（请选择1-2种）
4\. 输出要求：  
生成：请提供3个符合要求的素材模板，包含通用框架和示例。  
提炼：请从'如果是提炼，请在此处粘贴需要分析的内容'中提炼出1个素材模板，并给出优化建议。  

示例输出格式：  
类型：故事素材  
模板： "___通过___方法，从___逆袭到___"  
示例： "小林通过坚持写作，从月薪3000的普通职员逆袭为年入百万的自媒体人"  
适用场景：职场、成长  
情绪标签：启发、行动  
```
...
内容领域：理财  
情绪触发点：警示、好奇  
输出要求：请从请从'如果是提炼，请在此处粘贴需要分析的内容'中提炼出1个素材模板，并给出优化建议。  
```
...
2.内容领域：情感  
3.情绪触发点：共鸣、启发  
4.输出要求：请提供3个符合要求的素材模板，包含通用框架和示例。
```